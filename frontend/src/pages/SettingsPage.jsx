        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="hidden md:block col-span-1 space-y-2">
            <nav className="flex flex-col gap-1 sticky top-24">
              <a
                href="#profile"
                className="px-4 py-3 rounded-xl bg-cyan-50 dark:bg-neon-cyan/10 text-cyan-600 dark:text-neon-cyan font-medium flex items-center justify-between"
              >
              ...
              <a
                href="#appearance"
                className="px-4 py-3 rounded-xl text-gray-600 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-white/5 font-medium flex items-center justify-between transition-colors"
              >
                <div className="flex items-center gap-3">
            ...
            >
              ...
              <div className="p-6">
                <p className="text-gray-500 dark:text-gray-400 mb-6">
                  {t("customize_how_cresta_looks_on_your_device") ||
                    "Customize how Cresta looks on your device."}
                </p>
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  >
                    <Sun
                      size={32}
                      className={`mb-3 ${theme === "light" ? "text-cyan-500" : "text-gray-400"}`}
                    />
                    <span
                      className={`font-medium ${theme === "light" ? "text-cyan-700 dark:text-cyan-300" : "text-gray-600 dark:text-gray-400"}`}
                    >
                  ...
                  >
                    <Moon
                      size={32}
                      className={`mb-3 ${theme === "dark" ? "text-neon-cyan" : "text-gray-400"}`}
                    />
                    <span
                      className={`font-medium ${theme === "dark" ? "text-white" : "text-gray-600 dark:text-gray-400"}`}
                    >
                    ...
                    >
                      <div className="flex items-center gap-4">
                        ...
                        <div className="text-left">
                          <div
                            className={`font-medium ${i18n.language === lang.code ? "text-gray-900 dark:text-white" : "text-gray-700 dark:text-gray-300"}`}
                          >
                            {lang.nativeName}
                          </div>
