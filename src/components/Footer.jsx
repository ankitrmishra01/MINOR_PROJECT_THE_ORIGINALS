...
const Footer = () => {
    ...
    return (
        <footer className="py-8 border-t border-gray-200 dark:border-white/10 mt-auto relative z-10 bg-white/80 dark:bg-fintech-primary/80 backdrop-blur-md transition-colors duration-300 pointer-events-none">
            <div className="container mx-auto px-6 text-center text-gray-600 dark:text-gray-500 pointer-events-auto">
